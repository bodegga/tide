...
```bash
curl -L -o tide-template.tar.gz https://github.com/bodegga/tide/releases/download/v1.0.0/Tide-Gateway-Template-v1.0.0.tar.gz
```
...
Outputs: `releases/Tide-Gateway-Template-v1.0.0.tar.gz`
